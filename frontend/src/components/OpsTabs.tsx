...
import { Activity, AlertCircle, ServerCog, ServerCrash, Workflow } from 'lucide-react'
...
const tabs = [
  ...
  { to: '/ops/service-errors', labelKey: 'serviceErrors.title', icon: <ServerCrash className="size-4" /> },

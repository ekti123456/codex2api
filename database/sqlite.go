...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS usage_logs (
			...
			session_id_prefix TEXT DEFAULT '',
			window_number_original TEXT DEFAULT '',
			window_number_outbound TEXT DEFAULT '',
			upstream_response_model TEXT DEFAULT '',
			turn_state_length INTEGER,
			turn_state_decoded_bytes INTEGER,
			turn_id TEXT DEFAULT '',
			is_turn_first_request INTEGER,
			turn_prompt_preview TEXT DEFAULT '',
	...
	columns := []struct {
		...
		{"usage_logs", "session_id_prefix", "TEXT DEFAULT ''"},
		{"usage_logs", "window_number_original", "TEXT DEFAULT ''"},
		{"usage_logs", "window_number_outbound", "TEXT DEFAULT ''"},
		{"usage_logs", "upstream_response_model", "TEXT DEFAULT ''"},
		{"usage_logs", "turn_state_length", "INTEGER"},
		{"usage_logs", "turn_state_decoded_bytes", "INTEGER"},
		{"usage_logs", "turn_id", "TEXT DEFAULT ''"},
		{"usage_logs", "is_turn_first_request", "INTEGER"},
		{"usage_logs", "turn_prompt_preview", "TEXT DEFAULT ''"},
	...
	indexStatements := []string{
		...
		`CREATE INDEX IF NOT EXISTS idx_usage_logs_turn_state_length_created ON usage_logs(turn_state_length, created_at DESC, id DESC);`,
